 ...
 * @param {string} validationExpectation A string describing what the validator is expected to
 *        ensure, typically starting with "to be...". E.g. "to be between $1 and $2". $1, $2 and so
 *        on are placeholders for the validationFn's parameters.
 *
 * @constructor
 */
